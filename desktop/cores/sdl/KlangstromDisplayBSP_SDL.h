...
#ifndef klangstrom_display_bsp_sdl_h
#define klangstrom_display_bsp_sdl_h
...
namespace klangstrom {
    class KlangstromDisplayBSP_SDL : public KlangstromDisplay {
    public:
        KlangstromDisplayBSP_SDL() {
            mPosition.x = 0;
            mPosition.y = 0;
        }
        void BSP_init() {}
...
#endif  // klangstrom_display_bsp_sdl_h
