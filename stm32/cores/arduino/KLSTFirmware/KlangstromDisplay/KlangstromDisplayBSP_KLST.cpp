...
#include "KlangstromDisplayBSP_KLST.h"
...
// @TODO(move HAL reference to `KlangstromDisplayBSP_KLST_SHEEP`)
...
klangstrom::KlangstromDisplayBSP_KLST* DisplayBSPPtr = new klangstrom::KlangstromDisplayBSP_KLST();
...
void klangstrom::KlangstromDisplayBSP_KLST::BSP_init() {
    ILI9341_Init();
}

void klangstrom::KlangstromDisplayBSP_KLST::BSP_set_pixel(const uint16_t x, const uint16_t y, const uint16_t color) {
    ILI9341_DrawPixel(x, y, color);
}

void klangstrom::KlangstromDisplayBSP_KLST::BSP_clear_background() {
...
void klangstrom::KlangstromDisplayBSP_KLST::BSP_line_vertical(uint16_t x0, uint16_t y0, uint16_t h, uint16_t color) {
...
void klangstrom::KlangstromDisplayBSP_KLST::BSP_line_horizontal(uint16_t x0, uint16_t y0, uint16_t w, uint16_t color) {
...
void klangstrom::KlangstromDisplayBSP_KLST::BSP_line(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color) {
    /**
...
void klangstrom::KlangstromDisplayBSP_KLST::BSP_rect_fill(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t color) {
    ILI9341_FillRectangle(x, y, w, h, color);
}

void klangstrom::KlangstromDisplayBSP_KLST::BSP_rect(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t color) {
...
void klangstrom::KlangstromDisplayBSP_KLST::BSP_character(uint16_t x, uint16_t y, char ch, const uint16_t foreground_color, const uint16_t background_color) {
    ILI9341_WriteChar(x, y, ch, *font, foreground_color, background_color);
}

void klangstrom::KlangstromDisplayBSP_KLST::BSP_block(uint16_t x, uint16_t y, uint16_t w, uint16_t h, const uint16_t* data) {
