...
klangstrom::KlangstromDisplay *DisplayPtr;

void klangstrom::KlangstromDisplayBSP_SDL::init(SDL_Renderer *pRenderer) {
    renderer = pRenderer;
...
void klangstrom::KlangstromDisplayBSP_SDL::draw() {
    /* lock texture */
...
void klangstrom::KlangstromDisplayBSP_SDL::BSP_set_pixel(const uint16_t x, const uint16_t y, const uint16_t color) {
...
void klangstrom::KlangstromDisplayBSP_SDL::BSP_clear_background() {
...
void klangstrom::KlangstromDisplayBSP_SDL::BSP_line_vertical(uint16_t x0, uint16_t y0, uint16_t h, const uint16_t color) {
    // @todo(optimize!)
    BSP_line(x0, y0, x0, y0 + h, color);
}

void klangstrom::KlangstromDisplayBSP_SDL::BSP_line_horizontal(uint16_t x0, uint16_t y0, uint16_t w, const uint16_t color) {
    // @todo(optimize!)
    BSP_line(x0, y0, x0 + w, y0, color);
}

void klangstrom::KlangstromDisplayBSP_SDL::BSP_line(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, const uint16_t color) {
    /**
...
void klangstrom::KlangstromDisplayBSP_SDL::BSP_rect_fill(uint16_t x, uint16_t y, uint16_t w, uint16_t h, const uint16_t color) {
...
void klangstrom::KlangstromDisplayBSP_SDL::BSP_rect(uint16_t x, uint16_t y, uint16_t w, uint16_t h, const uint16_t color) {
...
void klangstrom::KlangstromDisplayBSP_SDL::BSP_character(uint16_t x, uint16_t y, char ch, const uint16_t foreground_color, const uint16_t background_color) {
    if (font != nullptr) {
        uint32_t i, b, j;
...
void klangstrom::KlangstromDisplayBSP_SDL::BSP_block(uint16_t x, uint16_t y, uint16_t w, uint16_t h, const uint16_t *data) {
    ILI9341_Select();
...
void klangstrom::KlangstromDisplayBSP_SDL::ILI9341_SetAddressWindow(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1) {
...
void klangstrom::KlangstromDisplayBSP_SDL::ILI9341_WriteData(uint8_t *buff, size_t buff_size) {
