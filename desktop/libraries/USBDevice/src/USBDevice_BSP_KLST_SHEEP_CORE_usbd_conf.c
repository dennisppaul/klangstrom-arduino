...
#define USBD_STATIC_MALLOC_SIZE 5 
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  /* USER CODE END USB_OTG_FS_MspDeInit 0 */
    ...
    PA12     ------> USB_OTG_FS_DP
    */
    HAL_GPIO_DeInit(GPIOA, PA11|PA12);
...
{
  static uint32_t mem[USBD_STATIC_MALLOC_SIZE];
  return mem;
}
...
#endif // KLST_BOARD_KLST_SHEEP || KLST_BOARD_KLST_CORE
#endif // USE_USBDEVICE
