...
bool klangstrom::KlangstromCardBSP_STM32::begin() {
...
bool klangstrom::KlangstromCardBSP_STM32::begin(const char *pFolderPath) {
    // @TODO(maybe set some kind of file root here?)
    return begin();
}

void klangstrom::KlangstromCardBSP_STM32::get_file_list(vector<String> &pFiles, bool pIncludeHiddenFiles) {
...
bool klangstrom::KlangstromCardBSP_STM32::is_open() {
    return mFile != nullptr && mFile->isOpen();
}

void klangstrom::KlangstromCardBSP_STM32::close() {
...
void klangstrom::KlangstromCardBSP_STM32::print_WAV_header(WaveHeader_t *mHeader) {
